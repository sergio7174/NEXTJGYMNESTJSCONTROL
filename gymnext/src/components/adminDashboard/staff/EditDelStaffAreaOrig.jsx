  ...
  const GetAllStaffs =  () => { GetAllStaffsService(setStaffs); };
   ...
   const handleUpdate = async (e) => {
    ...
    e.preventDefault();
      ...
      alert("Estoy en handleUpdate - editDelStaff-area - line 145 - updatedgender: "+updatedgender);
      alert("Estoy en handleUpdate - editDelProduct-area - line 146 - image: "+image);
